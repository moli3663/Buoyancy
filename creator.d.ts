...
declare module cc._decorator {	
	...
	``` 
	*/
	export function ccclass(name? : string) : void;	
	/** !#en
	...
	``` 
	*/
	export function property(options? : { type? : Any; url? : RawAsset; visible? : boolean; displayName? : string; tooltip? : string; multiline? : boolean; readonly? : boolean; min? : number; max? : number; step? : number; range? : Number[]; slide? : boolean; serializable? : boolean; editorOnly? : boolean; override? : boolean; animatable? : boolean; }) : void;	
	/** !#en
	...
	``` 
	*/
	export function executeInEditMode() : void;	
	/** !#en
	...
	``` 
	*/
	export function requireComponent(requiredComponent : Component) : void;	
	/** !#en
	...
	``` 
	*/
	export function menu(path : string) : void;	
	/** !#en
	...
	``` 
	*/
	export function executionOrder(order : number) : void;	
	/** !#en
	...
	``` 
	*/
	export function disallowMultiple() : void;	
	/** !#en
	...
	``` 
	*/
	export function playOnFocus() : void;	
	/** !#en
	...
	``` 
	*/
	export function inspector(url : string) : void;	
	/** !#en
	...
	``` 
	*/
	export function help(url : string) : void;	
	/** NOTE:<br>
	...
	``` 
	*/
	export function mixins(ctor : Function) : void;
}
